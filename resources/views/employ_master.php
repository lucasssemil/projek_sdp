      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu_open">
          ...
          <ul class="treeview-menu">
			<li id="employ_master"><a id="active_menu" href="employmaster"><i class="fa fa-circle-o"></i> See Employee Data</a></li>
  ...
  <div class="content-wrapper">
	...
	<li class='active'>See Item Lists</li>
          ...
          <!-- TABLE: LATEST ORDERS -->
                ...
                echo "<th>Golongan Pegawai</th>";
				echo "<th>Status Pegawai</th>";
                ...
                echo "<tbody>";
						...
						foreach($data as $value)
						{
							...
							echo "<tr>";
							echo "<form method='get' action='updatingp'>" ;
							echo "<td>".$value->id_pegawai."</td>";
							echo "<td><input type='text' name='pname' value='".$value->peg_name."'></td>";
							echo "<td><select name='golongan'>";
							if($value->peg_golongan=='Manager'){
								echo "<option selected>".$value->peg_golongan."</option>";
								echo "<option>Warehouse</option>";
							}
							else if($value->peg_golongan == 'Warehouse')
							{
							...
							else
							{
								...
								echo "<option selected>Nonaktif</option>";
							}
							echo "</select></td>";
							
							
							echo "<td><button id='bupdate' name='updateid' class='btn btn-default' value=".$value->id_pegawai.">Update</button></td>";
							echo "</form>";
							
							echo "<form method='get' action='deletingp'>" ;
							echo "<td><button id='bdelete' name='deleteid' class='btn btn-default' value=".$value->id_pegawai.">Delete</button></td>";
							echo "</form>" ;
							echo "</tr>";
						}

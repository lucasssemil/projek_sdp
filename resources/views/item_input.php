...
<div class="wrapper">
        ...
        <li class="treeview">
		 ...
		 <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li id="items_input"><a id="active_menu" href="iteminput"><i class="fa fa-circle-o"></i> Input New Item </a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
       ...
       <ol class='breadcrumb'> 
			...
			<li class='active'>Input New Item</li>
			</ol>
			
			<div class='box box-info'>
			 <div class='box-header with-border'>
				<h3 class='box-title'>Input New Item</h3>
			</div>
			 <div class='box-body' id='form_input'>
			<table id='table1' class='table table-bordered table-striped'>
			 <thead>
			<tr>
			<form method='post' action='inserting'>
			<table>
			<tr>
			<td>ID Barang </td>
			<td> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type='text' name='idbarang' required></td>
			</tr>
			<tr>
			<td>Nama Barang </td>
			<td> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type='text' name='nmbarang' id='barang_nm' required></td>
			</tr>
			<td>Stok Gudang </td>
			<td> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type='number' name='sgudang' required></td>
			</tr>
			<td>Harga Barang </td>
			<td> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type='number' id='harga' name='hbarang' placeholder='Rp.0,-' required></td>
			</tr>
			</table>
